...
def open_file():
            file_path = filedialog.askopenfilename(filetypes=(('Текстовые документы (*.txt)', '*.txt'), ('Все файлы', '*.*')))
            if file_path:
...
def show_stats():
            ...
            messagebox.showinfo('Статистика', f'Символов: {chars}\nСлов: {words}\nСтрок: {lines}')
...
file_menu.add_separator()
file_menu.add_command(label='Время', command=localtimer)
...
format_menu_sub.add_command(label='Сбросить форматирование', command=reset_formatting)
...
theme_menu.add_command(label='Тёмная', command=lambda: chenge_theme('dark'))
theme_menu.add_command(label='Светлая', command=lambda: chenge_theme('light'))
theme_menu.add_command(label='Морская', command=lambda: chenge_theme('ocean'))
theme_menu.add_command(label='Лесная', command=lambda: chenge_theme('forest'))
theme_menu.add_command(label='Лунная', command=lambda: chenge_theme('moon'))
theme_menu.add_command(label='Кофейная', command=lambda: chenge_theme('coffee'))
